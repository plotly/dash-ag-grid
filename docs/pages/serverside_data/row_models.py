...
- ### Client-Side
 ...
 <dccLink href="/clientside-data/updating-data" children="Go to Client-Side Row Model" />
- ### Infinite
 ...
 <dccLink href="/server-side-data/infinite-role-model" children="Go to Infinite Row Model" />
...
- ### Server-Side  (Enterprise)
 ...
 [Go to Server-Side Row (AG Grid Docs)](https://www.ag-grid.com/react-data-grid/server-side-model/)
...
[Go to Viewport Row Model (Ag Grid Docs)](https://www.ag-grid.com/react-data-grid/viewport/)
...
See the AG Grid docs [Row Models](https://www.ag-grid.com/react-data-grid/row-models/) section for a feature comparison of all the grid's features across all four row models.
...
<img src="https://user-images.githubusercontent.com/72614349/236704035-612098f2-2fa3-4338-9746-9586ebdbb900.png" alt="Diagram of Major Classes involved with the Row Models" style="max-width: 100%; margin-bottom: 1rem;" />
