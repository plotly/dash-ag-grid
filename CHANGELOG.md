...
- [#462](https://github.com/plotly/dash-ag-grid/pull/462)
  - Updated workflow test targets to Python 3.10, Python 3.13, and React 19.
  - Kept dev requirements as `dash[ci,dev,testing]` and adjusted CI Python coverage to 3.13.
