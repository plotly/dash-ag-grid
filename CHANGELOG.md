...
- [#246](https://github.com/plotly/dash-ag-grid/pull/246/) `dataTypeDefinitions` now supports full js, partial python with full definitions in js of an object, and objects have parts that are js
